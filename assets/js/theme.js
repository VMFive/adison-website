...
// Use the old data set until dateForNewerDataSet
let dateForNewerDataSet = new Date('2019-12-17T00:00:00.52+08:00')
// console.log({dateForNewerDataSet});
if (Date.now() - dateForNewerDataSet.getTime() < 0) {
  // Old
  demoMapping = {
